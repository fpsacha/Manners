...
do
	...
	local short = {}
	local loaded = true
	-- The locale table stays in: every file reads ns.L as it loads, so leaving
	-- it out as well would fail on the first translated line rather than on the
	-- file this scenario is about.
