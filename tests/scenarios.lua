...
do
	...
	local short = {}
	local loaded = true
	-- The toc's own list with the one file taken out, rather than a copy of
	-- it written here: a toc that lost Flavour.lua still loads the locale
	-- table ahead of everything else, and Core.lua reads it at load.
	local files = {}
	for _, file in ipairs(ADDON_FILES) do
